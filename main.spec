...
a = Analysis(
    ...
    datas=[
        ...
        ('Development/Samples/Python/MvImport/MvCameraControl_class.py', 'Development/Samples/Python/MvImport'),
        ('Development/Samples/Python/MvImport/MvErrorDefine_const.py', 'Development/Samples/Python/MvImport'),
        ('Development/Samples/Python/MvImport/CameraParams_header.py', 'Development/Samples/Python/MvImport'),
        ('Development/Samples/Python/MvImport/PixelType_header.py', 'Development/Samples/Python/MvImport'),
        ('Development/Samples/Python/MvImport/CameraParams_const.py', 'Development/Samples/Python/MvImport'),
        ('Settings', 'Settings'),
        ('Logs', 'Logs'),
    ],
    hiddenimports=[
