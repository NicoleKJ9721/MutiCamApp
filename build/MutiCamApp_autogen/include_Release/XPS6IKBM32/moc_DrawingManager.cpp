...
#include "../../../../src/domain/drawing/services/DrawingManager.h"
...
void DrawingManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->viewUpdated((*reinterpret_cast< std::add_pointer_t<QLabel*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QImage>>(_a[2]))); break;
        default: ;
        }
        ...
        {
            using _t = void (DrawingManager::*)(QLabel * , const QImage & );
            if (_t _q_method = &DrawingManager::viewUpdated; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DrawingManager::viewUpdated(QLabel * _t1, const QImage & _t2)
{
