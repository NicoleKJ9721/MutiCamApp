...
QGroupBox* CalibrationDialog::createMethodGroup()
{
    ...
    QFont descFont = singlePointDesc->font();
    descFont.setPointSize(9);
    singlePointDesc->setFont(descFont);
    singlePointDesc->setStyleSheet("color: #666;");
    ...
    multiPointDesc->setFont(descFont);
    multiPointDesc->setStyleSheet("color: #666;");
    ...
    circleDesc->setFont(descFont);
    circleDesc->setStyleSheet("color: #666;");
    ...
    stageAssistedDesc->setFont(descFont);
